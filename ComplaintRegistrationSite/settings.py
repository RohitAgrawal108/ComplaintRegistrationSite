"""
Django settings for ComplaintRegistrationSite project.
...
SECRET_KEY = 'django-insecure-&yqpe+@=*1no&axbh8uw(l5)k6yjlz!)s*p&-8d&b_%p-b8$hi'
...
ROOT_URLCONF = 'ComplaintRegistrationSite.urls'
...
WSGI_APPLICATION = 'ComplaintRegistrationSite.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': "ComplaintRegistrationSite_db",#config('DB_NAME'),
        'USER': "postgres",#config('DB_USER'),
        'PASSWORD': "123zxcvbnm",#config('DB_USER_PASSWORD'),
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'ComplaintRegistrationSite/static')]
